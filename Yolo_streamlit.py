...
with modelVal:
    ...
    if mod_val == 'Augmented':
        confusion_matrix2_path = 'https://github.com/OfirSL/Trash_sorting_project/blob/78ced0badbc0d0fcd8615415f5f9a81574640d7a/yolov8n_EcoVision_full/val2_conf_0.4_best/confusion_matrix.png'
